          ...
          <div className="overflow-hidden bg-white border-2 border-green-100 shadow-lg rounded-xl">
            ...
            <div className="p-3 space-y-3">
              ...
              <div className="p-3 border border-gray-200 rounded bg-gray-50">
                <h4 className="mb-2 text-sm font-bold text-gray-800">ચાર્જ સારાંશ:</h4>
                <div className="space-y-1 text-xs">
                  ...
                  <div className="flex justify-between text-base font-bold">
                    ...
                    <span>₹{(billData.total_rent + billData.worker_charge + billData.lost_plate_penalty).toFixed(2)}</span>
                  </div>
                  ...
                  <div className={`flex justify-between text-xl font-bold ${
                    (billData.total_rent + billData.worker_charge + billData.lost_plate_penalty - billData.advance_paid) > 0 ? 'text-red-600' : 'text-green-600'
                  }`}>
                    <span>અંતિમ બાકી / FINAL DUE:</span>
                    <span>₹{Math.max(0, billData.total_rent + billData.worker_charge + billData.lost_plate_penalty - billData.advance_paid).toFixed(2)}</span>
                  </div>
                </div>
              </div>
