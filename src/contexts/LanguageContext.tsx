...
const translations = {
  ...
  'Partner Stock': { gu: 'પાર્ટનર સ્ટોક', en: 'Partner Stock' },
  ...
  'Partner': { gu: 'પાર્ટનર', en: 'Partner' },
  'Partner Selection': { gu: 'પાર્ટનર પસંદગી', en: 'Partner Selection' },
  'Main Stock': { gu: 'મુખ્ય સ્ટોક', en: 'Main Stock' },
  'SS Partner': { gu: 'SS પાર્ટનર', en: 'SS Partner' },
  'SK Partner': { gu: 'SK પાર્ટનર', en: 'SK Partner' },
